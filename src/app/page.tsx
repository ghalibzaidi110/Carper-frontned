...
import { Car, ScanSearch, Camera, FileText, ChevronRight } from "lucide-react";
...
export default function LandingPage() {
  ...
  const features = [
    ...
    { icon: Camera, title: "Live Detection", desc: "Real-time damage detection through your camera — point, scan, and review on the spot." },
  ...
  const steps = [
    { num: "01", title: "Upload Images", desc: "Drop in car photos from any angle — JPG, PNG, or WEBP up to 10 MB each." },
    { num: "02", title: "AI Analyzes", desc: "Our model scans for dents, scratches, and damage with confidence scores." },
    { num: "03", title: "Get Your Report", desc: "Review annotated images, severity levels, and download a full PDF report." },
  ];
        ...
        <div className="relative container mx-auto px-4 py-24 lg:py-36">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-lg text-primary-foreground/70 max-w-xl leading-relaxed">
              ...
              with annotated detections, severity scores, and exportable PDFs.
            </p>
